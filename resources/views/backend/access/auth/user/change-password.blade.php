...
@section('content')
{{ html()->form('PATCH', route('access.auth.user.change-password.post', $user))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('access.auth.user.index'), __('buttons.general.cancel')) }}
                </div><!--col-->
