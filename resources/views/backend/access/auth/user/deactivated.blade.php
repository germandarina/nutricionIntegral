        ...
        <div class="row">
            <div class="col-sm-5">
                <h5 class="card-title mb-0">
                    {{ __('labels.backend.access.users.management') }} <small class="text-muted">{{ __('labels.backend.access.users.deactivated') }}</small>
                </h5>
            </div><!--col-->
    ...
    <script>
        $(function () {
            $('.data-table').DataTable({
                ...
                "serverSide": true,
                "draw": true,
                ajax: "{{ route('access.auth.user.deactivated') }}",
                columns: [
