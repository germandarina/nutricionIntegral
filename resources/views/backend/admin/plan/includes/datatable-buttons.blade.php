    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenu2" x-placement="bottom-start" style="will-change: transform; margin: 0px;">
            ...
            @else
                ...
                <a title="Duplicar Planificación"  href='#' onclick="duplicatePlanning(event, {{ $row->id }})" class="dropdown-item"><i style="color:green;" class="fas fa-copy" data-toggle="tooltip" data-placement="top" title="Duplicar Planificación"></i> <strong>Duplicar Plan</strong></a>
