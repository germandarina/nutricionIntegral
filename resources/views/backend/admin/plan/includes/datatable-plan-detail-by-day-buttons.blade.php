@if(!$row->trashed())
    <div class="btn-group btn-group-sm" role="group" >
        <a title="Ver" href='#' onclick="showRecipe(event,{{$row->recipe_id}},{{$row->id}})" class="btn btn-info"><i class="fas fa-eye" data-toggle="tooltip" data-placement="top" title="Ver"></i></a>
