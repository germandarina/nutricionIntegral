@foreach($recipes as $recipe)
    <div class="col-sm-4 mb-3" style="max-height: 40%;">
        <div class="card" style="margin-bottom: 0px !important;">
            <div class="accordion @if(in_array($recipe->id,$recipes_already_used_in_plan)) recipe_used_in_plan @elseif(in_array($recipe->id,$ids_recipes_already_used)) recipe_used @endif" id="accordion" role="tablist" >
