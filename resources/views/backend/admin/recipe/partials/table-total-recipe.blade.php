    ...
    <table class="table table-responsive-sm table-sm table-condensed font-xs ">
        <thead class="bg-success">
            <tr>
                ...
                <th style="text-align: center;">Total Grasa Total (g)</th>
                <th style="text-align: center;">Total Carbohidratos Totales (g)</th>
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center;"><a href="#" class="btn btn-sm btn-success" onclick="getTotalCompleto({{$recipe->id}})"><i class="fas fa-eye"></i></a></td>
            </tr>
        </tbody>
    </table>
</div>
